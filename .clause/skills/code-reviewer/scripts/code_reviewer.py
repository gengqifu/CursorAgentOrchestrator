"""Code Reviewer Skill 入口脚本。

本脚本是 code-reviewer skill 的执行入口，由 Agent 根据 SKILL.md 指导调用。
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="审查代码 - code-reviewer skill 入口"
    )
    ...
    try:
        result = review_code(args.workspace_id, args.task_id)
