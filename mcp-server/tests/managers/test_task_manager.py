...
class TestTaskManager:
    ...
    def test_get_tasks_returns_empty_list_when_no_tasks(self, manager, workspace_manager, sample_project_dir):
        """测试没有任务时返回空列表。"""
        # Arrange
    ...
    def test_get_tasks_returns_tasks_from_file(self, manager, workspace_manager, sample_project_dir):
        """测试从文件读取任务。"""
        # Arrange
        workspace_id = create_test_workspace(
            workspace_manager,
    ...
    def test_get_task_returns_specific_task(self, manager, workspace_manager, sample_project_dir):
        """测试获取特定任务。"""
        # Arrange
        workspace_id = create_test_workspace(
            workspace_manager,
    ...
    def test_get_task_raises_error_when_not_found(self, manager, workspace_manager, sample_project_dir):
        """测试获取不存在任务时抛出异常。"""
        # Arrange
        workspace_id = create_test_workspace(
            workspace_manager,
    ...
    def test_update_task_status_updates_task(self, manager, workspace_manager, sample_project_dir):
        """测试更新任务状态。"""
        # Arrange
        workspace_id = create_test_workspace(
            workspace_manager,
        ...
        # Act
        manager.update_task_status(workspace_id, "task-001", "completed", code_files=["file.py"])
