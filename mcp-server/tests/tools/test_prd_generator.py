...
class TestPRDGenerator:
    ...
    def test_generate_prd_with_valid_url(self, temp_dir, monkeypatch, workspace_manager, sample_project_dir):
        """测试使用有效 URL 生成 PRD。"""
        # Arrange
    ...
    def test_generate_prd_with_file_path(self, temp_dir, monkeypatch, workspace_manager, sample_project_dir):
        """测试使用文件路径生成 PRD。"""
        # Arrange
        workspace_id = create_test_workspace(
            workspace_manager,
    ...
    def test_generate_prd_with_invalid_url(self, temp_dir, monkeypatch, workspace_manager, sample_project_dir):
        """测试使用无效 URL 应该失败。"""
        # Arrange
        workspace_id = create_test_workspace(
            workspace_manager,
    ...
    def test_generate_prd_creates_prd_file(self, temp_dir, monkeypatch, workspace_manager, sample_project_dir):
        """测试生成 PRD 文件。"""
        # Arrange
        workspace_id = create_test_workspace(
            workspace_manager,
