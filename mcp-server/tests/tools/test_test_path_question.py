...
class TestTestPathQuestion:
    ...
    def test_ask_test_path_missing_project_path(
        self, temp_dir, workspace_manager
    ):
    ...
    def test_submit_test_path_empty(self, temp_dir, sample_project_dir, workspace_manager):
        """测试提交空路径。
    ...
    def test_submit_test_path_missing_project_path(
        self, temp_dir, workspace_manager
    ):
    ...
    def test_ask_test_path_exception(
        ...
        with patch('src.tools.test_path_question.WorkspaceManager') as mock_manager_class:
